...
export default function ThemeToggle() {
  ...
  return (
    <button type="button" aria-label="Toggle theme" onClick={toggle} className="mr-4 cursor-pointer">
      <span className="relative inline-flex h-6 w-12 items-center rounded-full border border-[var(--color-border)] bg-[var(--color-accent)] transition-colors duration-200">
        <span
          className="ml-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-surface)] transition-transform duration-200 will-change-transform"
