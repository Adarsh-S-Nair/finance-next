  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      <Sidebar
        ...
        showToggle={isTablet}
      />
      <div className="min-h-screen flex flex-col transition-all duration-300 ease-in-out md:ml-20 xl:ml-72 bg-[var(--color-content-bg)] dark:rounded-tl-3xl dark:rounded-bl-3xl">
        <AppTopbar />
