...
export default function AppTopbar() {
  ...
  return (
    <header className="sticky top-0 z-20 h-16 bg-[var(--color-bg)]/90 backdrop-blur supports-[backdrop-filter]:bg-[color-mix(in_oklab,var(--color-bg),transparent_6%)] border-b border-[var(--color-border)] dark:border-transparent">
