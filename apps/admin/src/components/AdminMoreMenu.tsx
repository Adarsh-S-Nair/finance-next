...
/**
 * Bottom-of-sidebar "..." menu for the admin app. Mirrors finance's
 * SidebarMoreMenu pattern: an ellipsis trigger that opens a popover to
 * the right, containing identity, theme toggle, and sign-out. Keeping
 * the menu shape identical to finance's makes the two apps feel like
 * one product.
 */
export default function AdminMoreMenu({ name, email, avatarUrl, initials }: Props) {
