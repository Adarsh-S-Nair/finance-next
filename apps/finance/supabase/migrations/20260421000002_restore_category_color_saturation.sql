-- Bring saturation back to category colors.
-- The previous "soften" revert went too muted; this restores a moderately
-- saturated palette (HSL ~40-55% sat, ~50-60% lightness) so categories are
-- visually distinct without looking neon.
